...
3. In loop update inputs e.g. p1[0] = analogRead...; p1[2] = analogRead...
4. Calculate weighted sum and store in variable e.g. float weightedSum = p1.feedForward();
5. Tran compared obtained with some desired e.g. p1.train(desired, obtained);
*/
//**************Class perceptron*************
class perceptron
{

...
#define NUM_INPUTS       13    // 6 on the front + 12 on the back
...
int pinNumbers[NUM_INPUTS] = {
  ...
  5,        // left side of female header, KEBYBOARD
...
void updateOutLEDs()
{
  ...
  /************ CAMBIAR ACA PARA ASIGNAR LOS IMPUTS ******/
  for (int i=0; i<NUM_INPUTS; i++)
  {
    if (inputs[i].pressed)
    {

...
/* 
  ...
  The methods are:
   ...
   slowmove()  - Behaves like write() but moves the servo at reduced speed.
...
public:
  ...
  void slowmove(int value, uint8_t speed);	// Move to given position at reduced speed.
					// speed=0 is identical to write, speed=1 slowest and speed=255 fastest.
					// On the RC-Servos I tested, speeds differences above 127 can't be noticed,
					// because fo the mechanical limits of the servo.
